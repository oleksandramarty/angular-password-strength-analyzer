...
describe('pwdWeightAnalyze function', () => {
  ...
  const testData: { id: number, pwd: string, expected: number, expectedTitle: string, minLen?: number }[] = [
    ...
    { id: 4, pwd: 'qwertyuiop', expected: 2, expectedTitle: passwordWeightDefaultText.weak, },
    { id: 5, pwd: '1234567890', expected: 2, expectedTitle: passwordWeightDefaultText.weak, },
    ...
    { id: 21, pwd: 'passssasssss', expected: 2, expectedTitle: passwordWeightDefaultText.weak, },
    { id: 22, pwd: '', expected: 0, expectedTitle: passwordWeightDefaultText.empty, },
    { id: 23, pwd: '123', expected: 2, minLen: 2, expectedTitle: passwordWeightDefaultText.weak, },
    { id: 24, pwd: '00000000000000000000000000000A', expected: 3, minLen: 2, expectedTitle: passwordWeightDefaultText.weak, },
    { id: 25, pwd: '0', expected: 1, minLen: 2, expectedTitle: passwordWeightDefaultText.tooShort, },
    { id: 26, pwd: '00', expected: 2, minLen: 2, expectedTitle: passwordWeightDefaultText.weak, },
    { id: 27, pwd: '000', expected: 2, minLen: 2, expectedTitle: passwordWeightDefaultText.weak, },
    { id: 28, pwd: '0000', expected: 2, minLen: 2, expectedTitle: passwordWeightDefaultText.weak, },
    { id: 29, pwd: '00000', expected: 2, minLen: 2, expectedTitle: passwordWeightDefaultText.weak, },
    { id: 30, pwd: '000000', expected: 2, minLen: 2, expectedTitle: passwordWeightDefaultText.weak, },
    { id: 31, pwd: '0000000', expected: 2, minLen: 2, expectedTitle: passwordWeightDefaultText.weak, },
    { id: 32, pwd: '00000000', expected: 2, minLen: 2, expectedTitle: passwordWeightDefaultText.weak, },
  ];
